-- Inserting new record to the table `account`
...
WHERE account_firstname = 'Tony' AND account_id = 1;
...
--and the classification name field from the classification table for inventory items that belong
--to the "Sport" category
SELECT inv_make, inv_make, classification_name
FROM public.inventory inv
JOIN public.classification cl
